...
public class MobileController {
	...
	public ResponseEntity<MobileDto> updateMobileInfoById(@PathVariable int id, @RequestBody MobileDto mobile){
		return new ResponseEntity<MobileDto>(mobileService.updateMobileInfoById(id, mobile), HttpStatus.OK);
	}
